    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col  justify-center text-center px-5 p-5 lg:p-10 ",
          )}
        >
          ...
          {id === 1 && (
            <div className="mt-6 flex flex-col gap-6 z-10">
              <div>
                <p className="text-sm text-gray-400 mb-4 text-left">Frontend</p>
              ...
              <div>
                <p className="text-sm text-gray-400 mb-4 text-left">Backend</p>
                <div className="flex gap-4 flex-wrap">
          ...
          {id === 5 && (
            <div className="mt-6 flex flex-col gap-6 z-10">
              ...
              <div>
                <p className="text-sm text-gray-400 mb-4 text-left">Game Dev</p>
                <div className="flex gap-4 flex-wrap">
